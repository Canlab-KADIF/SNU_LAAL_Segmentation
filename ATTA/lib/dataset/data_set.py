...
class Fishyscapes(Dataset):
    ...
    def __init__(self, split='Static', root='your_dataset_path/fs_', transform=None, domain_shift = False, inlier_label = False):
        """Load all filenames."""
...
class RoadAnomaly(Dataset):
    ...
    def __init__(self, root='your_dataset_path', transform=None):
        """Load all filenames."""
        self.transform = transform
        self.root = root
        self.images = []  # list of all raw input images
